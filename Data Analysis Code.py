...
# Keep only the valid year range
ds = ds.sel(time=slice('2018-01-01', '2018-12-31T23:00:00'))
...
# 1) Select February through May 2018
ds_4m = ds.sel(time=slice("2018-02-01", "2018-02-28"))
...
# 4) Save to CSV
output_file = "germany_2018_Feb_May_mean.csv"
